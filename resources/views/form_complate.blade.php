...
<body class="mg0">
    ...
    <footer class="footerSection mgT150px pd100">
        <div>
            <div class="center relative">
            <a href="top.html"><img src="img/KOA-footer_logo.png" width="150px"></a>
            ...
            <ul>
                <li class="dspIB white topic7 mgR50px"><a href="/contact" class="textnone white topic7 mgR50px">お問い合わせ</a></li>
