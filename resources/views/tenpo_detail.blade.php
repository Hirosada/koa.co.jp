...
<html lang="ja">
    <head>
        ...
        <script src="js/jquery-fadethis-master/dist/jquery.fadethis.js"></script>
    </head>
    <body class="mg0">
        ...
        <div class="relative">
            <img src="/img/tenpo_mv.jpg" class="w100">
            <span class="title_posi topic7 f50px"><span class="f20px topic7">洗練された空間</span><br>店舗デザイン</span>
        </div>
        <div class="center mgT100px topic7">
            <span class="f30px">店舗デザイン</span>
        </div>
        <div class="center mgT50px topic7 w50 mg0A lineH2">
            <span>
                興亜では、屋外サインのイメージデザインも含めた、商業施設、文化施設、医療施設など店舗デザイン事業を展開しています。
                企画・設計・施工まで一貫して自社で行っていますので、無駄もありませんし、サポートも充実しています。
                また、お店がオープンした後のアドバイス等も行っておりますので、何でもご相談下さい。
            </span>
        </div>
        <div class="center mgT50px">
            <img src="/img/works/shoolarue.jpg" class="mgR50px">
            <img src="/img/works/quatrereves.jpg" class="mgR50px">
            <img src="/img/works/parish.jpg" class="mgR50px">
        </div>    
        <div class="center">
          <div class="mgT100px topic7 f30px">
            <span>店舗デザイン設計の流れ</span>
        </div>
        <div class="topic7 mgT50px">
            <span class="f20px">打ち合わせから着工・完成引渡し・アフターフォローまでお任せ下さい!!</span><br>
        </div>
        <div class="center topic7 mgT20px w50 mg0A">
            <span>新築からリフォームまで予算に合わせてお任せ下さい。お客様のご意見やご要望をお伺いし、機能やデザインを 重視したプランを致しております。 ご要望を聞き取り、現場をしっかりと確認し、お客様の納得のいくまで打合せを重ねます。
            </span>
        </div>
        <div class="mgT50px">
            <img src="/img/tenpo_nagare.gif">
        </div>
